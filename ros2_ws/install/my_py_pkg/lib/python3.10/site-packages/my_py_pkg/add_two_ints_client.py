...
class AddTwoIntsClientNode(Node): 
    def __init__(self):
        ...
        self.call_add_two_ints_server(4, 4)
    
    def call_add_two_ints_server(self, a, b):
        client = self.create_client(AddTwoInts,"add_two_ints")
    
        while not client.wait_for_service(1.0):
            self.get_logger().warn("Waiting for server Ad Two Ints...")
        ...
        future.add_done_callback(partial(self.callback_call_add_two_ints_server, a=a, b=b))
