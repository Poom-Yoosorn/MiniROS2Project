...
class LedPanelNode(Node): 
    def __init__(self):
        ...
        self.led_states_timer_ = self.create_timer(1.0,self.publish_led_states)
        self.set_led_service_ = self.create_service(SetLedOriginal,"set_led",self.callback_set_led)
