...
class Init_LedStatus_led3_on
{
public:
  Init_LedStatus_led3_on()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::my_robot_interfaces::msg::LedStatus led3_on(::my_robot_interfaces::msg::LedStatus::_led3_on_type arg)
  {
    msg_.led3_on = std::move(arg);
...
{
  return my_robot_interfaces::msg::builder::Init_LedStatus_led3_on();
}
